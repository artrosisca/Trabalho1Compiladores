...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NOME = 3,                       /* NOME  */
  YYSYMBOL_NOME_AGENTE = 4,                /* NOME_AGENTE  */
  ...
  YYSYMBOL_OU = 9,                         /* OU  */
  YYSYMBOL_NAO = 10,                       /* NAO  */
  YYSYMBOL_PORCENTAGEM = 11,               /* PORCENTAGEM  */
  YYSYMBOL_ABRE_CHAVE = 12,                /* ABRE_CHAVE  */
  YYSYMBOL_FECHA_CHAVE = 13,               /* FECHA_CHAVE  */
  YYSYMBOL_ABRE_PARENTESES = 14,           /* ABRE_PARENTESES  */
  YYSYMBOL_FECHA_PARENTESES = 15,          /* FECHA_PARENTESES  */
  YYSYMBOL_PONTO_VIRGULA = 16,             /* PONTO_VIRGULA  */
  YYSYMBOL_YYACCEPT = 17,                  /* $accept  */
  YYSYMBOL_programa = 18,                  /* programa  */
  YYSYMBOL_lista_agente = 19,              /* lista_agente  */
  YYSYMBOL_crencas = 20,                   /* crencas  */
  YYSYMBOL_objetivos = 21,                 /* objetivos  */
  YYSYMBOL_planos = 22,                    /* planos  */
  YYSYMBOL_plano_set = 23,                 /* plano_set  */
  YYSYMBOL_condicao = 24,                  /* condicao  */
  YYSYMBOL_contexto = 25,                  /* contexto  */
  YYSYMBOL_acoes = 26,                     /* acoes  */
  YYSYMBOL_lista_simples = 27,             /* lista_simples  */
  YYSYMBOL_nome_plano = 28,                /* nome_plano  */
  YYSYMBOL_nome_agente = 29,               /* nome_agente  */
  YYSYMBOL_list_element_name = 30          /* list_element_name  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NOME", "NOME_AGENTE",
  "CRENCAS", "OBJETIVOS", "PLANOS", "E", "OU", "NAO", "PORCENTAGEM",
  "ABRE_CHAVE", "FECHA_CHAVE", "ABRE_PARENTESES", "FECHA_PARENTESES",
  "PONTO_VIRGULA", "$accept", "programa", "lista_agente", "crencas",
  "objetivos", "planos", "plano_set", "condicao", "contexto", "acoes",
  "lista_simples", "nome_plano", "nome_agente", "list_element_name", YY_NULLPTR
};
...
{
       1,   -28,     6,   -28,     2,   -28,    -3,     4,     8,     0,
       7,   -28,     3,    -1,     8,     5,     9,   -28,     8,    10,
      15,     1,   -28,   -28,   -28,    11,    12,   -28,   -28,    16,
      13,    -2,   -28,    -6,    18,    19,    24,    25,    14,     8,
      17,    20,    21,   -28,    22,    23,   -28,   -28,   -28,    15,
     -28
};
...
{
       3,    19,     0,     2,     0,     1,     0,     0,    16,     0,
       0,    20,     0,     0,    16,     0,     0,     5,    16,     0,
       8,     3,    17,     6,    18,     0,     0,     4,     7,     0,
       0,     0,    10,    14,     0,     0,     0,     0,     0,    16,
       0,     0,     0,    13,     0,     0,    11,    12,    15,     8,
       9
};
...
{
      19,    33,    36,    37,    22,     1,     5,     6,    34,     8,
       9,    11,    14,    27,    15,    18,    17,    20,    24,    30,
      21,    38,    50,    23,    28,    44,    29,    41,    42,    32,
      43,    39,    45,     0,     0,    48,    46,    47,     0,    49
};

static const yytype_int8 yycheck[] =
{
      14,     3,     8,     9,    18,     4,     0,     5,    10,    12,
       6,     3,    12,    21,     7,    16,    13,    12,     3,     3,
      11,     3,    49,    13,    13,    39,    14,     3,     3,    16,
      16,    12,    15,    -1,    -1,    13,    16,    16,    -1,    16
};
...
{
       0,     4,    18,    19,    29,     0,     5,    20,    12,     6,
      21,     3,    27,    30,    12,     7,    22,    13,    16,    27,
      12,    11,    27,    13,     3,    23,    28,    19,    13,    14,
       3,    24,    16,     3,    10,    25,     8,     9,     3,    12,
      26,     3,     3,    16,    27,    15,    16,    16,    13,    16,
      23
};
